...
BEGIN
	INSERT INTO R2D2_ARTURITO.CATEGORIA (descripcion)
		SELECT DISTINCT
...
BEGIN
	INSERT INTO R2D2_ARTURITO.MARCA(descripcion)
		SELECT DISTINCT
			M.PRODUCTO_MARCA
		FROM GD1C2024.gd_esquema.Maestra M
...
BEGIN
	...
	SELECT DISTINCT
		...
		D.id_direccion AS id_direccion
	FROM GD1C2024.gd_esquema.Maestra M
		INNER JOIN R2D2_ARTURITO.DIRECCION D ON M.CLIENTE_DOMICILIO = D.domicilio
