...
BEGIN
	INSERT INTO R2D2_ARTURITO.BI_UBICACION(localidad,provincia)
	SELECT 
...
BEGIN
	INSERT INTO R2D2_ARTURITO.BI_SUCURSAL(nombre)
...
BEGIN
	INSERT INTO R2D2_ARTURITO.BI_MEDIO_PAGO(descripcion)
...
BEGIN
	INSERT INTO R2D2_ARTURITO.BI_CATEGORIZACION_PRODUCTOS(descripcion_categoria,descripcion_subcategoria)
	SELECT
